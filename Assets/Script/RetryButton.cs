...
public class RetryBtn : MonoBehaviour
{
    ...
    public void OnEnterStage1()             //스테이지 1 씬으로 넘어가기
    {
        SceneManager.LoadScene("StageLevel1");
    }

    public void OnEnterStage2()             //스테이지 2 씬으로 넘어가기
    {
        SceneManager.LoadScene("StageLevel2");
    }

    public void OnEnterStage3()             //스테이지 3 씬으로 넘어가기
    {
        SceneManager.LoadScene("StageLevel3");
    }
